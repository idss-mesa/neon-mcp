#!/usr/bin/env python3
"""Validate the neon-mcp docs/ tree against Open Knowledge Format (OKF) v0.2 conformance.

Identical logic to the UNM-CARC/docs validator (the reference OKF bundle); only
this docstring differs. Needs only PyYAML — no project import, so it runs in CI
...
Usage: python scripts/okf_validate.py docs      (from the repository root)
